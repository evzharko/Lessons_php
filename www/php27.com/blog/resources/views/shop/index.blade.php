            ...
            <div class="latest-items">
                ...
                <div class="tab-content row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <div class="product-single">
                                    <div class="product-thumb">
                                        ...
                                        <div class="actions">
                                            <ul>
                                                ...
                                                {{--<li><a class="zoom" href="{{$product->img}}"><span--}}
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="price"> {{$product->price}} грн.
                                            {{--<del> $50</del>--}}
                                        </div>
                                    </div>
                                    <!--/.product-info-->
                    ...
                    <div id="women" class="tab-pane fade">
                        @foreach($products_womens as $products_women)
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="product-single">
                                <div class="product-thumb">
                                    <img class="img-responsive" alt="Single product"
                                         src="{{$products_women->img}}">
                                    <div class="actions">
                                        <ul>
                                            <li><a class="add-cart" href="single-product.html"><span><span
                                                                class="icon_plus"></span></span> add to cart</a>
